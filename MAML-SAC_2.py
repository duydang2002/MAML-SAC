...
#           tasks = self.task_selection(actions, rewards, H)
    ...
    def init_target_network(self, K,H):  
        ...
        self.target_actor_network.compile(optimizer=optimizers.Adam(0.0001),
                               loss=sac_loss)  
        ...
        self.target_q0_network.compile(optimizer=optimizers.Adam(0.0001),
        ...
        self.target_q1_network.compile(optimizer=optimizers.Adam(0.0001),
                               loss=tf.keras.losses.mse)  
        ...
        self.v_network_target.compile(optimizer=optimizers.Adam(0.0001),
                               loss=tf.keras.losses.mse) 
        ...
        self.target_v_network_target.compile(optimizer=optimizers.Adam(0.0001),
                               loss=tf.keras.losses.mse)  
